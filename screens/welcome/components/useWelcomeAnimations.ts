/**
 * @file screens/welcome/components/useWelcomeAnimations.ts
 * @description Hook לניהול כל האנימציות של מסך Welcome
 * @author GYMoveo Development
 * @version 1.0.0
 *
 * @hook useWelcomeAnimations
 * @parent WelcomeScreen
 *
 * @notes
 * - ניהול מרכזי של כל האנימציות
 * - אנימציות כניסה, יציאה ומחזוריות
 * - תמיכה בהגדרות מהירות שונות
